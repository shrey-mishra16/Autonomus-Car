...
class World(object):
    ...
    def restart(self, args):
        ...
        blueprint= self.world.get_blueprint_library().filter("grandtourer")[0]
        ...
        while True:
            ...
            if args.agent == "Roaming" or args.agent == "Basic":
                ...
                if np.random.random() < epsilon:
                    ...
                    control.steer = np.random.randint(-1,1)

                    control.throttle = np.random.random()

                    control.brake = np.random.random()
